...
print(string.format(" %d.%d.%d (%s)", osversion.majorversion, osversion.minorversion, osversion.revision,
...
newoption {trigger = "ios", description = "Enable iOS target (requires xcode4)"}
...
newoption {trigger = "enable_stable_pd", description = "Enable Stable PD control in PyBullet"}
...
newoption {trigger = "noopengl3", description = "Don't compile any OpenGL3+ code"}

newoption {trigger = "midi", description = "Use Midi controller to control parameters"}

newoption {trigger = "enable_egl", value = false, description = "Build an experimental eglPlugin"}
...
newoption {trigger = "no-demos", description = "Don't build demos"}

newoption {trigger = "no-extras", description = "Don't build extras"}
...
newoption {trigger = "lua", description = "Enable Lua scipting support in Example Browser"}
...
newoption {trigger = "enable_glfw", value = false, description = "(optional) use GLFW 3.x library"}
...
if _OPTIONS["enable_glfw"] then
	...
	function initOpenGL()
		...
		includedirs {_OPTIONS["glfw_include_dir"]}

		libdirs {_OPTIONS["glfw_lib_dir"]}
