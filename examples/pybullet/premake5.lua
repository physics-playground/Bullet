...
if (hasCL) then
	links {"Bullet3OpenCL_clew", "Bullet3Dynamics", "Bullet3Collision", "Bullet3Geometry", "Bullet3Common"}
end
...
includedirs {_OPTIONS["python_include_dir"]}
libdirs {_OPTIONS["python_lib_dir"]}
