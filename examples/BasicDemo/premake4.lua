...
links {"BulletDynamics", "BulletCollision", "LinearMath", "OpenGL_Window", "Bullet3Common"}
...
links {"BulletDynamics", "BulletCollision", "LinearMath", "Bullet3Common"}
...
if _OPTIONS["enable_openvr"] then
	...
	includedirs {"../../src", "../ThirdPartyLibs/openvr/headers", "../ThirdPartyLibs/openvr/samples/shared"}

	links {"BulletDynamics", "BulletCollision", "LinearMath", "OpenGL_Window", "Bullet3Common", "openvr_api"}
