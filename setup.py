...
sources = (
    ["examples/pybullet/pybullet.c"] + ["examples/ThirdPartyLibs/tinyxml2/tinyxml2.cpp"] +
    ...
    ["examples/SharedMemory/plugins/stablePDPlugin/SpAlg.cpp"] + ["src/btLinearMathAll.cpp"] +
    ["src/btBulletCollisionAll.cpp"] + ["src/btBulletDynamicsAll.cpp"] +
    ["examples/ExampleBrowser/InProcessExampleBrowser.cpp"] +
    ["examples/TinyRenderer/geometry.cpp"] + ["examples/TinyRenderer/model.cpp"] +
    ["examples/TinyRenderer/tgaimage.cpp"] + ["examples/TinyRenderer/our_gl.cpp"] +
    ...
    ["examples/SharedMemory/b3PluginManager.cpp"] + ["examples/Utils/b3ResourcePath.cpp"] +
    ["examples/Utils/RobotLoggingUtil.cpp"] + ["examples/Utils/ChromeTraceUtil.cpp"] +
    ["examples/Utils/b3Clock.cpp"] + ["examples/Utils/b3Quickprof.cpp"] +
    ["examples/ThirdPartyLibs/Wavefront/tiny_obj_loader.cpp"] +
    ["examples/ThirdPartyLibs/stb_image/stb_image.cpp"] +
    ["examples/ThirdPartyLibs/stb_image/stb_image_write.cpp"] +
    ["examples/ThirdPartyLibs/minizip/ioapi.c"] + ["examples/ThirdPartyLibs/minizip/unzip.c"] +
    ["examples/ThirdPartyLibs/minizip/zip.c"] + ["examples/ThirdPartyLibs/zlib/adler32.c"] +
    ["examples/ThirdPartyLibs/zlib/compress.c"] + ["examples/ThirdPartyLibs/zlib/crc32.c"] +
    ["examples/ThirdPartyLibs/zlib/deflate.c"] + ["examples/ThirdPartyLibs/zlib/gzclose.c"] +
    ["examples/ThirdPartyLibs/zlib/gzlib.c"] + ["examples/ThirdPartyLibs/zlib/gzread.c"] +
    ["examples/ThirdPartyLibs/zlib/gzwrite.c"] + ["examples/ThirdPartyLibs/zlib/infback.c"] +
    ["examples/ThirdPartyLibs/zlib/inffast.c"] + ["examples/ThirdPartyLibs/zlib/inflate.c"] +
    ["examples/ThirdPartyLibs/zlib/inftrees.c"] + ["examples/ThirdPartyLibs/zlib/trees.c"] +
    ["examples/ThirdPartyLibs/zlib/uncompr.c"] + ["examples/ThirdPartyLibs/zlib/zutil.c"] + [
    ...
    ["examples/ThirdPartyLibs/enet/callbacks.c"] + ["examples/ThirdPartyLibs/enet/compress.c"] +
    ["examples/ThirdPartyLibs/enet/host.c"] + ["examples/ThirdPartyLibs/enet/list.c"] +
    ["examples/ThirdPartyLibs/enet/packet.c"] + ["examples/ThirdPartyLibs/enet/peer.c"] +
    ["examples/ThirdPartyLibs/enet/protocol.c"] + ["examples/ExampleBrowser/OpenGLGuiHelper.cpp"] +
    ...
    ] + ["examples/OpenGLWindow/GLPrimitiveRenderer.cpp"] + ["examples/OpenGLWindow/TwFonts.cpp"] +
    ["examples/OpenGLWindow/GLRenderToTexture.cpp"] + ["examples/OpenGLWindow/LoadShader.cpp"] +
    ["examples/OpenGLWindow/OpenSans.cpp"] + ["examples/OpenGLWindow/SimpleCamera.cpp"] +
    ["examples/OpenGLWindow/fontstash.cpp"] + ["examples/OpenGLWindow/SimpleOpenGL2App.cpp"] + [
    ...
    ] + ["src/Bullet3Common/b3Logging.cpp"] + ["src/Bullet3Common/b3Vector3.cpp"] + [
    ...
    ["extras/InverseDynamics/CloneTreeCreator.cpp"] + ["extras/InverseDynamics/IDRandomUtil.cpp"] +
    ["extras/InverseDynamics/MultiBodyTreeDebugGraph.cpp"
    ] + ["extras/InverseDynamics/User2InternalIndex.cpp"] +
    ["extras/InverseDynamics/CoilCreator.cpp"] + ["extras/InverseDynamics/MultiBodyNameMap.cpp"] +
    ...
    ["src/BulletInverseDynamics/IDMath.cpp"] + ["src/BulletInverseDynamics/MultiBodyTree.cpp"] + [
    ...
    ] + ["examples/ThirdPartyLibs/BussIK/Misc.cpp"] + ["examples/ThirdPartyLibs/BussIK/Node.cpp"] +
    ["examples/ThirdPartyLibs/BussIK/Tree.cpp"] + ["examples/ThirdPartyLibs/BussIK/VectorRn.cpp"] +
    ["examples/ThirdPartyLibs/Gwen/Anim.cpp"] + ["examples/ThirdPartyLibs/Gwen/DragAndDrop.cpp"] +
    ["examples/ThirdPartyLibs/Gwen/Hook.cpp"] + ["examples/ThirdPartyLibs/Gwen/ToolTip.cpp"] +
    ["examples/ThirdPartyLibs/Gwen/events.cpp"] + ["examples/ThirdPartyLibs/Gwen/BaseRender.cpp"] +
    ["examples/ThirdPartyLibs/Gwen/Gwen.cpp"] + ["examples/ThirdPartyLibs/Gwen/Skin.cpp"] + [
        ...
        ] + ["extras/VHACD/test/src/main_vhacd.cpp"] + ["extras/VHACD/src/VHACD.cpp"] +
    ["extras/VHACD/src/vhacdICHull.cpp"] + ["extras/VHACD/src/vhacdManifoldMesh.cpp"] +
    ["extras/VHACD/src/vhacdMesh.cpp"] + ["extras/VHACD/src/vhacdVolume.cpp"])
...
egl_renderer_sources = (
    ...
    ["examples/OpenGLWindow/SimpleCamera.cpp"] + ["examples/Utils/b3Clock.cpp"] +
    ...
    ["src/Bullet3Common/b3Logging.cpp"] + ["src/LinearMath/btAlignedAllocator.cpp"] +
    ["src/LinearMath/btConvexHull.cpp"] + ["src/LinearMath/btConvexHullComputer.cpp"] +
    ["src/LinearMath/btGeometryUtil.cpp"] + ["src/LinearMath/btQuickprof.cpp"] +
    ["src/LinearMath/btThreads.cpp"] + ["src/Bullet3Common/b3AlignedAllocator.cpp"] +
    ["examples/ThirdPartyLibs/glad/gl.c"] + ["examples/OpenGLWindow/GLInstancingRenderer.cpp"] +
    ["examples/OpenGLWindow/GLRenderToTexture.cpp"] + ["examples/OpenGLWindow/LoadShader.cpp"])
...
if _platform == "linux" or _platform == "linux2":
  ...
  sources = (sources + ["examples/ThirdPartyLibs/enet/unix.c"] +
             ...
             ["examples/ThirdPartyLibs/glad/gl.c"] + ["examples/ThirdPartyLibs/glad/glx.c"])
  include_dirs += ["examples/ThirdPartyLibs/optionalX11"]

  if "BT_USE_EGL" in EGL_CXX_FLAGS:
    egl_renderer_sources = (egl_renderer_sources + ["examples/OpenGLWindow/EGLOpenGLWindow.cpp"] +
                            ["examples/ThirdPartyLibs/glad/egl.c"])
  else:
    egl_renderer_sources = (egl_renderer_sources + ["examples/OpenGLWindow/X11OpenGLWindow.cpp"] +
  ...
  sources = (["examples/ThirdPartyLibs/enet/unix.c"] +
             ["examples/OpenGLWindow/X11OpenGLWindow.cpp"] +
             ["examples/ThirdPartyLibs/glad/gl.c"] + sources)
...
for root, dirs, files in os.walk(hh):
  for fn in files:
    ...
    if (ext and ext in
        "yaml index meta data-00000-of-00001 png gif jpg urdf sdf obj txt mtl dae off stl STL xml gin npy "
        .split()):
      fn = root + "/" + fn
